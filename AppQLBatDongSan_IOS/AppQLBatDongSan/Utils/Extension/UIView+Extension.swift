...
extension UIView {
    func roundCorners(_ corners: UIRectCorner, radius: CGFloat, bound: CGRect? = nil) {
        let frame = bound ?? self.bounds
    ...
    func makeShadow(opacity: Float = 0.3, color: UIColor = .black) {
